        ...
        <div className="col-md-4">
          ...
          <div className="card" style={{ width: '100%' }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">Some quick example text for the first card.</p>
        ...
        <div className="col-md-4">
          ...
          <div className="card" style={{ width: '100%' }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">Some quick example text for the second card.</p>
              <a href="#" className="btn btn-primary">Go somewhere</a>
            </div>
          </div>
        </div>
        <div className="col-md-4">
          ...
          <div className="card" style={{ width: '100%' }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">Some quick example text for the third card.</p>
              <a href="#" className="btn btn-primary">Go somewhere</a>
            </div>
          </div>
        </div>
